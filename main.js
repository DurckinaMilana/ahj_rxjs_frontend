...
var timestamp = 0;
var url = "https://ahj-rxjs-polling-server.onrender.com/messages/unread/";
var messagesLength = 0;
var stream$ = interval(2000).pipe(switchMap(function () {
  return ajax.get(url + timestamp).pipe(map(function (_ref) {
...
var container = document.querySelector('.polling__container');
var getSubject = function getSubject(str) {
...
stream$.subscribe(function (arr) {
  if (!arr) return;
  for (var i = messagesLength; i < arr.length; i++) {
    var message = document.createElement('div');
    message.className = 'message';
    message.innerHTML = "\n      <span class=\"message__from\">".concat(arr[i].from, "</span>\n      <span class=\"message__subject\">").concat(getSubject(arr[i].subject), "</span>\n      <span class=\"message__time\">").concat(getDate(arr[i].received).toLocaleString(), "</span>\n    ");
